...
class EchoServer1Tests {
    ...
    @Test
    fun `clients are handled concurrently`() {
        // given: a listening server
        val serverAddress = InetSocketAddress("localhost", EchoServer1ThreadPerClient.PORT)
        val serverMainThread =
            Thread.ofVirtual().start {
                EchoServer1ThreadPerClient.main()
            }
        ...
        // - the messages of a given client are NOT contiguous
